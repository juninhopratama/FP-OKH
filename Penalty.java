            ...
            if (courseTaken.length > 1) {
                for (int i = 0; i < courseTaken.length; i++) {
                    for (int j = 0; j < courseTaken.length; j++) {
                        if (i != j && i<j) {
                            int timeslotCourse1 = timeslot[Integer.parseInt(courseTaken[i])];
                            int timeslotCourse2 = timeslot[Integer.parseInt(courseTaken[j])];
                            ...
                            if(jarak == 0){
                            //  System.out.println(courseTaken[i] + " " + courseTaken[j]);
